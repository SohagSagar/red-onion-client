            ...
            <div class="card-body">
                ...
                <form onSubmit={handleSubmit(onSubmit)} >
                    ...
                    <label htmlFor='image' class={`btn btn-sm btn-success rounded-full w-full text-white pb-0 normal-case ${loading ? 'loading' : ""}`}>
                       <BiCloudUpload  className='text-xl mr-1'/> {imageURL ? 'Image Uploaded' : <>{loading ? 'Uploading ...' : 'Upload Image'}</>}
                    </label>
                    ...
                    <div class="card-actions justify-center  mt-5">
                        <button disabled={!imageURL} type='submit' class="btn  btn-primary rounded-full w-full normal-case font-semibold">Add Food</button>
                    </div>
